...
x-i18n:
    generated_at: "2026-04-07T06:55:00Z"
    model: gpt-5.4
    provider: openai
...
| `model`       | string   | Surcharge fournisseur/modèle, par exemple `openai/gpt-image-1`                        |
...
- La détection automatique tient compte de l'authentification. Une valeur par défaut de fournisseur n'entre dans la liste des candidats
  que lorsque OpenClaw peut effectivement authentifier ce fournisseur.
...
| Édition/référence     | Oui (jusqu'à 5 images) | Oui (jusqu'à 5 images) | Oui (1 image)     | Oui (1 image, réf. sujet)  | Oui (1 image, configurée par workflow) | Non   |
...
- [fal](/fr/providers/fal) — configuration du fournisseur d'images et de vidéo fal
